...
internal struct ColorName {
  ...
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#6c79db"></span>
  /// Alpha: 100% <br/> (0x6c79dbff)
  internal static let linkColor = ColorName(rgbaValue: 0x6c79dbff)
