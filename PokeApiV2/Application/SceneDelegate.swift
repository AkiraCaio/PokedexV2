...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var baseScreenCoordinator: BaseScreenCoordinator?
        ...
        self.initCoordinator(windowScene)
    }
    ...
    private func initCoordinator(_ windowScene: UIWindowScene) {
        ...
        window?.rootViewController = baseScreenCoordinator?.navigationController
